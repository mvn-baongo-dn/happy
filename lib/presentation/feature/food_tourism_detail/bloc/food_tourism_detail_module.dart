...
import './food_tourism_detail_presenter.dart';

class FoodTourismDetailModule extends BaseModule<FoodTourismDetailPresenter> {
  @override
  void register() {
    ...
    // or a singleton
    injector.registerFactory<FoodTourismDetailPresenter>(
